# explicações da análise exploratória

conteudo = """# Resultados da Análise Exploratória (EDA)
...
# Salvar as anotações no arquivo eda_resultados.md
with open("eda_resultados.md", "w") as f:
    f.write(conteudo)

print("Arquivo com anotações gerado.")
